  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Vendor</span> Cart
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > You currently have <?php echo $count; ?> vendor(s) in your cart. </p>
...
<i class="fa fa-chevron-left"></i> Continue Looking
...
<h3 class="text-center"> You may like these services </h3>
...
$manufacturer_name = isset($row_manufacturer['manufacturer_title']) ? $row_manufacturer['manufacturer_title'] : '';
...
<p class="text-muted">
Additional costs are calculated based on the values you have entered.
</p>
